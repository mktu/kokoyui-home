...
export default function Hero() {
  return (
    <section className="relative overflow-hidden pt-20 md:pt-24 bg-bg-outer">
      {/* コンテンツ領域 */}
      <div className="max-w-6xl mx-auto bg-bg-content">
        ...
        <div className="relative py-12 md:py-16 px-4">
          ...
          <motion.div
            ...
            className="absolute rounded-full bg-gradient-to-b from-[#f7dc6f] to-[#f5c842] hidden md:block"
          ...
          <motion.div
            ...
            className="absolute rounded-full bg-gradient-to-b from-[#f8b4a0] to-[#e8967e] opacity-80 hidden md:block"
          ...
          >
            <h2 className="text-2xl md:text-3xl lg:text-[40px] font-serif text-gray-800 mb-6 md:mb-8">
              そこに信頼できる場所
            </h2>
            <p className="text-sm md:text-base text-gray-600 leading-loose tracking-wider">
              この町で積み重ねてきた確かな実績と
              <br />
              寄り添いでいつでも頼れる安心を届けます。
            </p>
